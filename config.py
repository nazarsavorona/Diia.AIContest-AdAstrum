...
TARGET_ASPECT_RATIO = 1.5  # 2:3 ratio
...
SHADOW_DIFFERENCE_THRESHOLD = 30  # brightness difference for shadow detection
...
BACKGROUND_UNIFORMITY_THRESHOLD = 30.0  # color variance threshold
